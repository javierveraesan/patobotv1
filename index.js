...
const {
  ...
  + 'FN:TerruBot0.1\n' // Nama
  + 'ORG:TerruBot0.1;\n' // Nama bot
  + 'TEL;type=CELL;type=VOICE;waid=12252775810:+1 225 277-5810n' // Nomor bot
  + 'END:VCARD' 
  ...
  */
  ...
  〘 *BOT* 〙
  ‣ Prefijo:  *「 ${prefix} 」*
  ‣ Yo soy:  TerrucoBot0.1  
  ‣ Conección: *TERRUCO CONNECT 2021*
  ...
  *〘 TEXTO2 〙*
  ...
  ┃ _Ex : ${prefix}Ephoto 25 TerruBot0.1_
  ┠⊷️ *${prefix}Textpro list*
  ┃ _Lista de textpro
  ┠⊷️ *${prefix}Textpro (code + Texto)*
  ┃ _Ex : ${prefix}Textpro 55 TerruBot0.1_
  ┗━━━━━━━━━━━━━━━━━━━━
  *〘 IMAGENES 〙*
  ┏━━━━━━━━━━━━━━━━━━━━
  ┠⊷️ *${prefix}Cogan*
  ...
  *〘 OWNER 〙*
  ...
  ┗━━━━━━━━━━━━━━━━━━━━
  *TERRUCOS DE LA BEBA ARMY, CONCHA DE TU MADRE*
  `,
  ...
  *OVO :* _${Ovo}_`,
  ...
  pok = await getBuffer(nimek)
  Lxa.sendMessage(from, pok, image, {
	quoted: mek, caption: `TerruBot0.1`
  })
				  ...
				  case 'sticker':
					case 's':
					  ...
					  /*} else if ((isMedia || isQuotedImage) && colors.includes(args[0])) {
						  ...
						  reply(`Send the image with the caption .sticker or the image tag that has been sent`)
					  }
					  break
  ...
  */
  ...
  //--Convert stiker to image
				  case 'toimg':
					  ...
					  exec(`ffmpeg -i ${medimg} ${ran}`, (err) => {
						  ...
						  buffer = fs.readFileSync(ran)
						  Lxa.sendMessage(from, buffer, image, {quoted: mek, caption: 'TerruBot0.1'})
						  fs.unlinkSync(ran)
					  })
					  break
  ...
  break
	...
	reply(`        ────────────────\nHola mierda, *${pushname}* !!!\nEse comando no esta en mi lista : *${prefix}${command}*\nPor que chucha no lees el menu?*${prefix}Menu*\n        ────────────────`)
				  }
